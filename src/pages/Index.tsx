 ...
 */
const GrandsComptesView = lazy(() =>
  import(
    /* webpackChunkName: "view-gc" */ "@/components/dashboard/views/GrandsComptesView"
  ).then((m) => ({ default: m.GrandsComptesView })),
);
const PlugPlayView = lazy(() =>
  import(
    /* webpackChunkName: "view-pp" */ "@/components/dashboard/views/PlugPlayView"
  ).then((m) => ({ default: m.PlugPlayView })),
);
const B2CView = lazy(() =>
  import(
    /* webpackChunkName: "view-b2c" */ "@/components/dashboard/views/B2CView"
  ).then((m) => ({ default: m.B2CView })),
);
const CafeView = lazy(() =>
  import(
...
const ConsommableView = lazy(() =>
  ...
  ).then((m) => ({ default: m.ConsommableView })),
);
const EquipementView = lazy(() =>
  import(
    /* webpackChunkName: "view-equipement" */ "@/components/dashboard/views/EquipementView"
  ).then((m) => ({ default: m.EquipementView })),
);
const ServiceView = lazy(() =>
  import(
    /* webpackChunkName: "view-service" */ "@/components/dashboard/views/ServiceView"
  ).then((m) => ({ default: m.ServiceView })),
);
const RecapKpiView = lazy(() =>
  import(
    /* webpackChunkName: "view-recap-kpi" */ "@/components/dashboard/views/RecapKpiView"
  ).then((m) => ({ default: m.RecapKpiView })),
);
const RecapUniversView = lazy(() =>
  import(
    /* webpackChunkName: "view-recap-univers" */ "@/components/dashboard/views/RecapUniversView"
  ).then((m) => ({ default: m.RecapUniversView })),
);
